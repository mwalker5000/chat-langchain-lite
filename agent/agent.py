...
def build_agent():
    return create_agent(
        ...
        # FilesystemMiddleware removed: the chat agent has no legitimate need to write
        # files, and exposing write_file caused the model to fabricate unrequested
        # file-output workflows on long-form requests.
        middleware=[],
    )
